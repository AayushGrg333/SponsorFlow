...
const authAPI = {
    ...
    getGoogleAuthUrl: (userType)=>{
        return "".concat(API_BASE_URL, "/").concat(userType, "/auth/google");
    },
    // Forgot Password
...
const influencerAPI = {
    // Signup
    signup: async (data)=>{
        return fetchAPI("/influencer/auth/sign-up", {
            method: "POST",
            body: JSON.stringify(data)
        });
    },
    // Verify signup code
    verifySignupCode: async (username, code)=>{
        return fetchAPI("/auth/signup/verify/influencer/".concat(username), {
            method: "POST",
            body: JSON.stringify({
                code
            })
    ...
    resendVerifyCode: async (username)=>{
        return fetchAPI("/auth/signup/resend-verify/influencer/".concat(username), {
            method: "POST"
        });
    },
    // Profile setup
    ...
    getProfile: async (influencerId)=>{
        return fetchAPI("/influencer/profile/".concat(influencerId));
    },
    // Update profile
    updateProfile: async (influencerId, profileData)=>{
        return fetchAPI("/influencer/profile/".concat(influencerId), {
            method: "PUT",
            body: JSON.stringify(profileData)
        });
    ...
    listInfluencers: async (filters)=>{
        ...
        return fetchAPI("/influencer/profile/me?".concat(params));
    },
    // Get influencer campaigns
    getCampaigns: async (influencerId)=>{
        return fetchAPI("/influencer/profile/".concat(influencerId, "/campaigns"));
    },
    // Get applications by influencer
    getApplications: async (influencerId)=>{
        return fetchAPI("/applications/influencers/".concat(influencerId, "/applications"));
    }
};
const companyAPI = {
    // Signup
    signup: async (data)=>{
        return fetchAPI("/company/auth/sign-up", {
            method: "POST",
            body: JSON.stringify(data)
        });
    },
    // Verify signup code
    verifySignupCode: async (companyName, code)=>{
        return fetchAPI("/auth/signup/verify/company/".concat(companyName), {
            method: "POST",
            body: JSON.stringify({
                code
            })
    ...
    // Resend verification code
    resendVerifyCode: async (companyName)=>{
        return fetchAPI("/auth/signup/resend-verify/company/".concat(companyName), {
            method: "POST"
        });
    },
    // Profile setup
    ...
    getProfile: async (companyId)=>{
        return fetchAPI("/company/profile/".concat(companyId));
    },
    // Update profile
    updateProfile: async (companyId, profileData)=>{
        return fetchAPI("/company/profile/update-profile/".concat(companyId));
    },
    ...
    listCompanies: async (filters)=>{
        ...
        if (filters === null || filters === void 0 ? void 0 : filters.category) params.append("category", filters.category);
        if (filters === null || filters === void 0 ? void 0 : filters.search) params.append("search", filters.search);
        return fetchAPI("/company/profile/me?".concat(params));
    }
};
const campaignsAPI = {
    // List all campaigns
    list: async (filters)=>{
        ...
        if (filters === null || filters === void 0 ? void 0 : filters.category) params.append("category", filters.category);
        if (filters === null || filters === void 0 ? void 0 : filters.search) params.append("search", filters.search);
        return fetchAPI("/campaigns?".concat(params));
    },
    // Get single campaign
    get: async (campaignId)=>{
        return fetchAPI("/campaigns/".concat(campaignId));
    },
    // Create campaign
    ...
    getByCompany: async (companyId)=>{
        return fetchAPI("/campaigns/companies/".concat(companyId, "/campaigns"));
    }
};
const applicationsAPI = {
    // Create application
    create: async (campaignId, applicationData)=>{
        return fetchAPI("/applications/campaigns/".concat(campaignId, "/applications"), {
            method: "POST",
    ...
    getDetails: async (applicationId)=>{
        return fetchAPI("/applications/applications/".concat(applicationId));
    },
    // Update application status (accept/reject)
    updateStatus: async (applicationId, status)=>{
        return fetchAPI("/applications/applications/".concat(applicationId, "/status"), {
            method: "PATCH",
            body: JSON.stringify({
                status
            })
...
const authHelpers = {
    ...
    getAccessToken: ()=>{
        return ("TURBOPACK compile-time truthy", 1) ? localStorage.getItem("accessToken") : "TURBOPACK unreachable";
    },
    isAuthenticated: ()=>{
...
function SignupPage() {
    ...
    const [activeTab, setActiveTab] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("influencer");
    const [acceptTerms, setAcceptTerms] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [influencerData, setInfluencerData] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        username: "",
        email: "",
        password: ""
    });
    const [companyData, setCompanyData] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        companyName: "",
        email: "",
        password: ""
    });
    ...
    const handleInfluencerSubmit = async (e)=>{
        ...
        setIsLoading(true);
        setError(null);
        const { data, error: apiError } = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["influencerAPI"].signup(influencerData);
        if (apiError) {
            setError(apiError);
            setIsLoading(false);
            return;
        }
        router.push("/signup/verify/influencer/".concat(influencerData.username));
    };
    const handleCompanySubmit = async (e)=>{
        ...
        setIsLoading(true);
        setError(null);
        const { data, error: apiError } = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["companyAPI"].signup(companyData);
        if (apiError) {
            setError(apiError);
            setIsLoading(false);
            return;
        }
        router.push("/signup/verify/company/".concat(companyData.companyName));
    };
    const handleGoogleSignup = ()=>{
        setIsLoading(true);
        window.location.href = __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authAPI"].getGoogleAuthUrl(activeTab);
    };
    const benefits = [
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "absolute right-1/4 bottom-1/4 h-[400px] w-[400px] rounded-full bg-accent/10 blur-[100px]"
                    }, void 0, false, {
                        fileName: "[project]/frontend/src/app/signup/page.tsx",
                        lineNumber: 97,
                        columnNumber: 9
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "hidden w-1/2 flex-col justify-between bg-card/30 p-12 lg:flex",
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        ...
                                        children: "Create your free account and start connecting with the perfect partners for your growth."
                                    }, void 0, false, {
                                        fileName: "[project]/frontend/src/app/signup/page.tsx",
                                        lineNumber: 116,
                                        columnNumber: 13
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "space-y-4",
                                children: benefits.map((benefit, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    ...
                                    children: "who trust SponsorFlow"
                                }, void 0, false, {
                                    fileName: "[project]/frontend/src/app/signup/page.tsx",
                                    lineNumber: 136,
                                    columnNumber: 13
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "flex w-full flex-col justify-center px-4 py-12 lg:w-1/2 lg:px-12",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                        href: "/",
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                                        ...
                                                        }, void 0, true) : "Create Influencer Account"
                                                    }, void 0, false, {
                                                        fileName: "[project]/frontend/src/app/signup/page.tsx",
                                                        lineNumber: 293,
                                                        columnNumber: 17
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                                        ...
                                                        }, void 0, true) : "Create Company Account"
                                                    }, void 0, false, {
                                                        fileName: "[project]/frontend/src/app/signup/page.tsx",
                                                        lineNumber: 416,
                                                        columnNumber: 17
...
_s(SignupPage, "byFgGWEF+kZ79TvLXldmJUUafHo=", false, function() {
    return [
...
//# sourceMappingURL=frontend_src_ec9e4f9a._.js.map