...
export default function MessagesPage() {
          ...
          if (storedUser) {
               ...
               if (socket) {
                    ...
                    socket.on("message_sent", (data: any) => {
                         ...
                         // The message should already be in state from receive_message
                    });
     ...
     const loadUserDetailsAndCreateTempConversation = async (
          ...
          try {
               ...
               console.log("✅ Loaded user details:", { userName, userAvatar });
     ...
     const handleSend = () => {
          ...
          // For new conversations, optimistically add message to UI
