...
export default function InfluencerPublicProfile() {
  ...
  const handleMessageInfluencer = () => {
    ...
    console.log('Starting conversation with influencer:', profile._id)
    startConversation(user.id, user.role, profile._id, "influencer", router)
  }
            ...
            <div className="glass-card rounded-xl p-6">
              ...
              {user?.role === "company" && (
                <div className="mt-6 space-y-2">
                  <Button className="w-full" onClick={handleMessageInfluencer}>
