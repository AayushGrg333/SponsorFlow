...
export const setupSocket = (io: Server) => {
     ...
     io.on("connection", (socket) => {
          ...
          // In your setupSocket function, update the send_message handler:
          ...
          socket.on(
               ...
               async ({
                    ...
                    try {
                         if (!content.trim()) {
                              console.log("❌ Empty content, ignoring");
                              return;
                         }
                         ...
                         console.log("📤 Broadcasting message to users...");
                         ...
                         console.log(
                              `📊 Message broadcasted to ${sentCount} connected users`
                         );
                    } catch (error : any) {
                         console.error(
                              "❌ Error in send_message handler:",
                              error
                         );
