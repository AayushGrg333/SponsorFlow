                         ...
                         if (otherParticipant) {
                              try {
                                   ...
                                   if (
                                        ...
                                        Model = mongoose.model("User"); // ← Use "User" model
                                   } else if (
                                        otherParticipant.model === "company"
                                   ) {
                                        Model = mongoose.model("Company"); // ← Use "Company" model
                                   }
                                   ...
                                   if (Model) {
                                        participantDetails =
                                             await Model.findById(
                                                  ...
                                                  .select(
                                                       "username displayName companyName profileImage avatar profilePicture"
                                                  )
                                                  .lean();

                                        console.log(
                                             `Loaded ${otherParticipant.model} details:`,
                                             participantDetails
                                        );
                                   }
                              } catch (modelError) {
                                   console.error(
                                        "Error loading participant details:",
                                        modelError
                                   );
