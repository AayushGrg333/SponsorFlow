...
exports.campaignSchema = zod_1.z.object({
    ...
    startDate: zod_1.z.preprocess(function (val) { return (val ? new Date(val) : undefined); }, zod_1.z.date({
        required_error: "Start date is required",
        invalid_type_error: "Start date must be a valid date",
    })),
    endDate: zod_1.z.preprocess(function (val) { return (val ? new Date(val) : undefined); }, zod_1.z.date({
        required_error: "End date is required",
        invalid_type_error: "End date must be a valid date",
    }).refine(function (date) { return date instanceof Date; }, {
